...
const Footer: FC<FooterProps> = ({}) => {
    ...
    return (
        <div className={"w-full bg-AtelierBQ-Dark text-AtelierBQ-Light bottom-0 pt-20 mt-32"}>
            <div className={"grid grid-cols-2 md:grid-cols-4 mx-auto text-center justify-around items-center w-4/5 h-auto pb-32"}>
                <div className={"pb-5"}>
                    <p>Beispielweg 3</p>
                    <p>3006 Bern</p>
                    <p>Schweiz</p>
            ...
            <div className={"mx-auto bottom-1 text-center items-center p-2"}><Link className={"underline opacity-30 font-thin"} href={"https://yanik.pro"}>
